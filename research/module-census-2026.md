...
|---|---|---|---|---|---|---|---|---|---|
| mod-transmog | module | server | yes | crash combo: playerbots + mod-junk-to-gold (fix-PR open) | yes | 4 | 178★ top module; appearance NPC, pure fun for family; verify the crash-fix PR is merged before enabling alongside junk-to-gold | Linux | https://github.com/azerothcore/mod-transmog |
...
| noisiver/mod-junk-to-gold | module | server | yes (frozen) | mod-transmog crash combo (fix-PR — verify) | yes (wave 1, after transmog check) | 4 | 28★ auto-sell grays on loot — beloved QoL, proven in the repack; check the transmog interaction before enabling both | Linux | https://github.com/noisiver/mod-junk-to-gold |
...
| pangolp/mod-quest-loot-party | module | server | yes | noisiver/mod-groupquests overlap | maybe | 3 | 23★ whole group gets quest drops — with a bot party this removes the worst grind duplication; test bots-count-as-group | Linux | https://github.com/pangolp/mod-quest-loot-party |
